...
* Renders a given TicTacToe.Board to the console.
* @author Dan Nirel
*/
class Renderer {
	private static final int ROWS_PER_MARK = 1;
	private static final int COLS_PER_MARK = 3;
	...
	*/
	public Renderer() {
		if(Board.SIZE > 9 || Board.SIZE < 2) {
			String errorMsg = "TicTacToe.Board size must be in the range [2, 9]";
